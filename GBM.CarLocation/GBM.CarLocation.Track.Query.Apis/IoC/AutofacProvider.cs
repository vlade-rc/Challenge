...
namespace GBM.CarLocation.Track.Query.Api.IoC
{
    public class ActofactProvider : IoCProvider
    {
        ...
        private static void configureIoC(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CurrentCarLocationHandlerQuery>().Named<ICarLocationHandlerQuery>(FilterOperations.LocationForCarIdentifier.ToString());
